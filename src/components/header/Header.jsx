        ...
        <div className='p-10 w-full'>
            {/* header */}
              <div className='flex justify-between items-center py-2'>
                <a href="/"><h4 className='text-2xl'>Oussama Akhmis</h4></a>
                <span className='font-extralight md:text-lg text-sm'>- Software Engineer</span>
              </div>
            ...
            <div className='flex gap-2 items-center'>
                ...
                <span className='font-semibold text-sm'>@oussama_amjad</span>
                </a>
